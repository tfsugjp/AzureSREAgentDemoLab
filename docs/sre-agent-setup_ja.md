...
このガイドでは、GlobalAzureDemo2026 アプリケーションに Azure SRE Agent を統合し、Azure Monitor をインシデント ソースとして、Azure relay 経由で Azure DevOps、GitHub、またはその両方へインシデントを連携する構成を設定します。
